...
public class DistributedFileSystemProvider extends FileSystemProvider {
     ...
     * @throws FileSystemNotFoundException The file system, identified by the URI, does not exist
     ...
     * @throws FileAlreadyExistsException if a directory could not otherwise be created because a
     * file of that name already exists <i>(optional specific exception)</i>
     ...
     * supported
     * @throws FileAlreadyExistsException if the target file exists but cannot be replaced because
     * the {@code REPLACE_EXISTING} option is not specified <i>(optional specific exception)</i>
     ...
     * file, and {@link SecurityManager#checkExec(String) checkExec} is invoked when checking
     * execute access.
     */
    @Override
     ...
     * @return a file attribute view of the specified type, or {@code null} if the attribute view
     ...
     * @param options options indicating how symbolic links are handled
     * @return a map of the attributes returned; may be empty. The map's keys are the attribute
     ...
     * @throws IOException If an I/O error occurs
     * @throws SecurityException In the case of the default provider, and a security manager is
     * installed, its {@link SecurityManager#checkRead(String) checkRead} method denies read access
     * to the file. If this method is invoked to read security sensitive attributes then the
     ...
     * @param options options indicating how symbolic links are handled
     * @throws UnsupportedOperationException if the attribute view is not available
     * @throws IllegalArgumentException if the attribute name is not specified, or is not
     * recognized, or the attribute value is of the correct type but has an inappropriate value
