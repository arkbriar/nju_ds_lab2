 ...
 */
public class DistributedFileSystem extends java.nio.file.FileSystem {
    private final FileSystemProvider provider;

    public DistributedFileSystem(FileSystemProvider provider) {
     ...
     * @throws UnsupportedOperationException If the pattern syntax is not known to the
     * implementation
     ...
     * @throws UnsupportedOperationException If this {@code FileSystem} does not support watching
     * file system objects for changes and events. This exception is not thrown by {@code
     * FileSystems} created by the default provider.
     * @throws IOException If an I/O error occurs
     */
    @Override
